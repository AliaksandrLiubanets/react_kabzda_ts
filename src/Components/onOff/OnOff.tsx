...
export function OnOff() {
    ...
    let [isToggle, setToggle] = useState(false)
        ...
        return <div className={s.onOff}>
            <div className={isToggle ? s.on : s.empty} onClick={() => setToggle(isToggle = true)}>on</div>
            <div className={isToggle ? s.empty : s.off} onClick={() => setToggle(isToggle = false)}>off</div>
